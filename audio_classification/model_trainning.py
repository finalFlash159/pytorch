...
batch_size = 4
train_set = torchvision.datasets.ImageFolder(root='heartbeat_dataset/train', transform=transform)
trainloader = torch.utils.data.DataLoader(train_set, batch_size=batch_size, shuffle=True)
test_set = torchvision.datasets.ImageFolder(root='heartbeat_dataset/test', transform=transform)
...
class ImageSpectrogramClassificationNet(nn.Module):
...
model = ImageSpectrogramClassificationNet()      
# model(input).shape
